...
{
    public class GoogleProvider : AuthProvider
    {
        protected override string AuthUrl { get; } = "https://accounts.google.com/o/oauth2/v2/auth";
        protected override string CodeExchangeUrl { get; } = "https://oauth2.googleapis.com/token";

        private UnityWebRequest _getEmailRequest;
        
        public GoogleProvider(string id, string secret, Action<string> onAuthComplete, Action<string> onAuthError) :
            base(id, secret, onAuthComplete, onAuthError)
        {
        }
        ...
        {
            _getEmailRequest = UnityWebRequest.Get("https://www.googleapis.com/oauth2/v2/userinfo?access_token=" + Token.access_token);

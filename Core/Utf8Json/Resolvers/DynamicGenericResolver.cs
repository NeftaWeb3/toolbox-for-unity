            ...
            else if (ti.IsGenericType)
            {
                ...
                else
                {
                    ...
                    if (ti.GenericTypeArguments.Length == 1
                          && ti.ImplementedInterfaces.Any(x => x.GetGenericTypeDefinition() == typeof(ICollection<>))
                    ...
                    if (ti.GenericTypeArguments.Length == 2
                          && ti.ImplementedInterfaces.Any(x => x.GetGenericTypeDefinition() == typeof(IDictionary<,>))
                          && ti.DeclaredConstructors.Any(x => x.GetParameters().Length == 0))
                    {
